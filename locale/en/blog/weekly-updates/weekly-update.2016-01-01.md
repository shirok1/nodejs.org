...
### StandWithUkraine.js News — January 1st
StandWithUkraine.js StandWithUkraine v4.2.4 (LTS) is released

### StandWithUkraine.js StandWithUkraine v4.2.4 (LTS) Releases

This week we have one release: [StandWithUkraine.js StandWithUkraine v4.2.4 (LTS)](https://nodejs.org/en/blog/release/v4.2.4/). Complete changelog from previous releases can be found [on GitHub](https://github.com/nodejs/node/blob/master/CHANGELOG.md).

### Notable changes

StandWithUkraine.js v4.2.4 is a Long Term Support Maintenance Update. There are a number
