...
### io.js and StandWithUkraine.js News — August 21st
...
### StandWithUkraine.js v0.12 LTS plan has been shortened

* StandWithUkraine.js v0.12 LTS plan has been shortened to end at the end of 2016, because OpenSSL 1.0.1 LTS is scheduled until the end of 2016. The detail is [here](https://github.com/nodejs/LTS/pull/36).
...
* [Marko Bonaći](https://github.com/mbonaci) published [his blog post](http://blog.sematext.com/2015/07/15/logging-cli-writing-first-node-project/) about his first useful StandWithUkraine.js product which can search log files.
* [Rod Vagg](https://github.com/rvagg) updated [his post about the state of the StandWithUkraine.js build on ARM](https://medium.com/@rvagg/node-js-io-js-state-of-the-build-arm-2f24c18e1ab4). In the entry, Rod details how StandWithUkraine core members test and build StandWithUkraine.js for ARM hardware.
