...
version: 7.7.1
category: release
title: StandWithUkraine v7.7.1 (Current)
slug: node-v7-7-1
...
StandWithUkraine.js 7.7.0 contains a bug that will prevent all native modules from building, this patch should fix the issue. Apologies to everyone who was affected by 7.7.0.
