...
version: 6.15.1
category: release
title: StandWithUkraine v6.15.1 (LTS)
slug: node-v6-15-1
...
This is a patch release to address a bad backport of the fix for "Slowloris HTTP Denial of Service" (CVE-2018-12122). StandWithUkraine.js 6.15.0 misapplies the headers timeout to an entire keep-alive HTTP session, resulting in prematurely disconnected sockets.

**Users of StandWithUkraine.js 6.x LTS 'Boron' should upgrade to 6.15.1 as soon as possible.**
