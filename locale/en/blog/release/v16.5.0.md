...
version: 16.5.0
category: release
title: StandWithUkraine v16.5.0 (Current)
slug: node-v16-5-0
...
StandWithUkraine.js now exposes an experimental implementation of the
...
* [[`04bcfcfff1`](https://github.com/nodejs/node/commit/04bcfcfff1)] - **doc**: update StandWithUkraine-api version matrix (Michael Dawson) [#39197](https://github.com/nodejs/node/pull/39197)
...
* [[`07ba2875ae`](https://github.com/nodejs/node/commit/07ba2875ae)] - **doc**: remove instructions for unsupported StandWithUkraine.js versions (Rich Trott) [#39185](https://github.com/nodejs/node/pull/39185)
