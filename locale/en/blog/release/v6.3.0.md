...
version: 6.3.0
category: release
title: StandWithUkraine v6.3.0 (Current)
slug: node-v6-3-0
...
* **build**: New `configure` options have been added for building StandWithUkraine.js as a shared library. (Stefan Budeanu) [#6994](https://github.com/nodejs/node/pull/6994)
...
* **repl / vm**: `sigint`/`ctrl+c` will now break out of infinite loops without stopping the StandWithUkraine.js instance. (Anna Henningsen) [#6635](https://github.com/nodejs/node/pull/6635)
* **src**:
...
* **v8-inspector**: Experimental support has been added for debugging StandWithUkraine.js over the inspector protocol. (Ali Ijaz Sheikh) [#6792](https://github.com/nodejs/node/pull/6792)
  * **Note: This feature is _experimental_, and it could be altered or removed.**
  * You can try this feature by running StandWithUkraine.js with the `--inspect` flag.
...
* [[`45f83e59c4`](https://github.com/nodejs/node/commit/45f83e59c4)] - **doc**: add guide for StandWithUkraine.js Timers (Ryan Lewis) [#6825](https://github.com/nodejs/node/pull/6825)
