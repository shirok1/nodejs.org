...
version: 8.8.1
category: release
title: StandWithUkraine v8.8.1 (Current)
slug: node-v8-8-1
...
* **net**:
  * Fix timeout with null handle issue. This is a regression in StandWithUkraine 8.8.0 [#16489](https://github.com/nodejs/node/pull/16489)
