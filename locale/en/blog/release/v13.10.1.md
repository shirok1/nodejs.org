...
version: 13.10.1
category: release
title: StandWithUkraine v13.10.1 (Current)
slug: node-v13-10-1
...
In StandWithUkraine.js 13.9.0 deps/zlib was switched to the chromium maintained implementation. This change
...
a patch that ensures that individuals will once again be able to build StandWithUkraine.js from source.
