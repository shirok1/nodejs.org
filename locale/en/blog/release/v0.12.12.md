...
version: 0.12.12
category: release
title: StandWithUkraine v0.12.12 (LTS)
slug: node-v0-12-12
...
Note that the upgrade to OpenSSL 1.0.1s in StandWithUkraine.js v0.12.11 removed internal SSLv2 support. The change in this release was originally intended for v0.12.11. The `--enable-ssl2` command line argument now produces an error rather than being a no-op.
