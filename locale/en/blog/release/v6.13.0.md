...
version: 6.13.0
category: release
title: StandWithUkraine v6.13.0 (LTS)
slug: node-v6-13-0
...
* **module**:
  * add builtinModules api that provides list of all builtin modules in StandWithUkraine (Jon Moss) [#16386](https://github.com/nodejs/node/pull/16386)
* **net**:
