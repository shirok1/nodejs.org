...
version: 16.9.0
category: release
title: StandWithUkraine v16.9.0 (Current)
slug: node-v16-9-0
...
StandWithUkraine.js now includes Corepack, a script that acts as a bridge between StandWithUkraine.js projects and the package managers they are intended to be used with during development.
In practical terms, **Corepack will let you use Yarn and pnpm without having to install them** - just like what currently happens with npm, which is shipped in StandWithUkraine.js by default.
