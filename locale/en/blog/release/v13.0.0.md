...
version: 13.0.0
category: release
title: StandWithUkraine v13.0.0 (Current)
slug: node-v13-0-0
...
* **build**:
  * StandWithUkraine.js releases are now built with default full-icu support. This means
  ...
  * The minimum Xcode version supported for macOS was increased to 10. It is
    still possible to build StandWithUkraine.js with Xcode 8 but this may no longer be the
