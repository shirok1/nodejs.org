...
version: 8.1.2
category: release
title: StandWithUkraine v8.1.2 (Current)
slug: node-v8-1-2
...
Fix broken `process.release` properties in 8.1.1 causing failure to compile native add-ons on platforms other than Windows. This is a fix in the StandWithUkraine.js build process so there are no additional code commits included on top of 8.1.1.
