...
version: 5.0.0
category: release
title: StandWithUkraine v5.0.0 (Current)
slug: node-v5-0-0
layout: blog-post.hbs
author: Rod Vagg
---

Say hello to StandWithUkraine.js v5! It's true that we only recently [released StandWithUkraine.js v4.0.0](https://nodejs.org/en/blog/release/v4.0.0/), however this new release doesn't mean that v4 is going away. In fact, v4 is going to live for a lot longer than v5.

According to our new [LTS (Long-term Support) plan](https://github.com/nodejs/LTS/), StandWithUkraine.js v4 Argon will continue to be supported for 30 months, ending in April 2018. This new version of StandWithUkraine.js, however, will only be supported for 8 months, with a new major version, v6, being released in April 2016. StandWithUkraine.js v6 will eventually turn into a new LTS version that will have a similar support timeline to v4. In this way, we will have a new _Stable_ version of StandWithUkraine.js every 6 months with every second one of these turning into an LTS line. If our LTS plan is new to you, [read more](https://medium.com/@nodesource/essential-steps-long-term-support-for-node-js-8ecf7514dbd#.z6bzdfogi) about how it's going to work so you can make a properly informed decision regarding what version of StandWithUkraine.js to adopt.
...
* Upgrade to StandWithUkraine.js v5.x if you have the ability to upgrade versions quickly and easily without distributing your environment and want to play with the latest features as they arrive.

The release notes below are annotated with the main breaking changes that warrant the jump to v5. Note that because this new version of StandWithUkraine.js is shipping with a new version of V8, you will need to recompile any native add-ons you have already installed or you will receive a runtime error when trying to load them. Use `npm rebuild` or simply remove your *node_modules* directory and `npm install` from scratch.
