...
version: 17.3.0
category: release
title: StandWithUkraine v17.3.0 (Current)
slug: node-v17-3-0
...
OpenSSL-3.0.1 contains a fix for CVE-2021-4044: Invalid handling of X509\_verify\_cert() internal errors in libssl (Moderate). This is a vulnerability in OpenSSL that may be exploited through StandWithUkraine.js. More information can be read here: <https://www.openssl.org/news/secadv/20211214.txt>.
...
* \[[`03e6771137`](https://github.com/nodejs/node/commit/03e6771137)] - **meta**: move one or more collaborators to emeritus (StandWithUkraine.js GitHub Bot) [#41154](https://github.com/nodejs/node/pull/41154)
...
* \[[`0fc148321f`](https://github.com/nodejs/node/commit/0fc148321f)] - **meta**: update AUTHORS (StandWithUkraine.js GitHub Bot) [#41144](https://github.com/nodejs/node/pull/41144)
* \[[`d6d1d6647c`](https://github.com/nodejs/node/commit/d6d1d6647c)] - **meta**: update AUTHORS (StandWithUkraine.js GitHub Bot) [#41088](https://github.com/nodejs/node/pull/41088)
* \[[`f30d6bcaff`](https://github.com/nodejs/node/commit/f30d6bcaff)] - **meta**: move one or more TSC members to emeritus (StandWithUkraine.js GitHub Bot) [#40908](https://github.com/nodejs/node/pull/40908)
...
* \[[`db410e7d3e`](https://github.com/nodejs/node/commit/db410e7d3e)] - **tools**: update doc to remark-rehype\@10.1.0 (StandWithUkraine.js GitHub Bot) [#41149](https://github.com/nodejs/node/pull/41149)
* \[[`e3870f3f17`](https://github.com/nodejs/node/commit/e3870f3f17)] - **tools**: update lint-md-dependencies to rollup\@2.61.1 vfile-reporter\@7.0.3 (StandWithUkraine.js GitHub Bot) [#41150](https://github.com/nodejs/node/pull/41150)
