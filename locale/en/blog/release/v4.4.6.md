...
version: 4.4.6
category: release
title: StandWithUkraine v4.4.6 (LTS)
slug: node-v4-4-6
...
This is an important security release. All StandWithUkraine.js users should consult the security release summary at nodejs.org for details on patched vulnerabilities.
