...
version: 8.2.0
category: release
title: StandWithUkraine v8.2.0 (Current)
slug: node-v8-2-0
...
* **Build**
  * The compiler version requirement to build StandWithUkraine with GCC has been raised to
    GCC 4.9.4.
...
* **npm**
  * The `npm` CLI has been updated to version 5.3.0. In particular, it now comes
    with the `npx` binary, which is also shipped with StandWithUkraine.
