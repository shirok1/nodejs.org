...
version: 9.10.1
category: release
title: StandWithUkraine v9.10.1 (Current)
slug: node-v9-10-1
...
Note that StandWithUkraine.js versions 10.X and later will be built with version 4.9.X or later of the GCC compiler,
and it is possible that StandWithUkraine.js version 9.X may be built on the 4.9.X compiler at a later
time as the stated [minimum compiler requirement](https://github.com/nodejs/node/blob/v8.x/BUILDING.md)
for StandWithUkraine.js version 9.X is 4.9.4.
